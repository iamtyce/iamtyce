...
date: December 2022
description: Three years after introducing Encore, we reflect on what we've learned about scaling a design system across a rapidly growing organisation.
...
![Encore — a family of systems](/images/blog/can-i-get-an-encore/Encore_2.webp)

Encore was our answer to this complex landscape of products, teams, and ways of working at Spotify.

It represented the consolidation of existing initiatives — some official and many grassroots. It provided a single, unified framework that would replace the 22 distinct design systems that existed previously.
...
![Spotify's growth between late-2019 and 2022](/images/blog/can-i-get-an-encore/encore-growth.webp)

*Spotify's growth between late-2019 and 2022*
...
![The Encore model has evolved into a bit of a spider's web](/images/blog/can-i-get-an-encore/growth-challenged-model.webp)

*The Encore model has evolved into a bit of a spider's web*
...
Now that you see where we've been, let's break it down into some lessons we've learnt along the way.

## Lesson #1 – Reinforce our design goals, rather than our organisational model

Since launching Encore, it has rapidly become a great example of Conway's law or, in other words designing systems that reflect the org model. In our case, the idea of "local systems", a key principle for Encore's layered model, encouraged the system to reflect our org structure.

![Systems, not org charts](/images/blog/can-i-get-an-encore/systems-not-org-charts.webp)
...
![An old manual Coda table compared to our current Data Studio dashboard](/images/blog/can-i-get-an-encore/coda-to-analytics.webp)

*An old manual Coda table compared to our current Data Studio dashboard*
...
![Numerous requests for reusable mobile components from designers and engineers](/images/blog/can-i-get-an-encore/unnamed__13_.webp)

*Numerous requests for reusable mobile components from designers and engineers.*
...
![A comparison of non-semantic and semantic tokens — our previous non-semantic color token usage compared to our current semantically named color system](/images/blog/can-i-get-an-encore/semantic-tokens.webp)

*Our previous non-semantic color token usage, compared to our current semantically named color system*

For example, as part of a large accessibility drive in late 2020, we wanted to adjust the value of our most important color, Spotify Green, to improve contrast. We knew the Spotify Green token was being used thousands of times across iOS, Android, and web, but we didn't know where or how.
...
![Figgy Bot automatically synchronizing changes made in code with our Figma toolkits](/images/blog/can-i-get-an-encore/slack-popins.webp)

*Figgy Bot automatically synchronizing changes made in code with our Figma toolkits*
...
![Various documents that are part of our Encore embed program](/images/blog/can-i-get-an-encore/embeds.webp)

*Various documents that are part of our Encore embed program.*
