...
To ensure you get feedback that's helpful, tell your customers what you're looking for. If you're in an early, pre-release cycle, be upfront and clear with customers on what that means and exactly what type of feedback you're seeking. This means you're not asking for high-fidelity critiques, but instead seeking critical bugs and flaws in the product.
...
It's essential to understand the power in communicating via SEMVER to help your customers understand what a release is expected to contain before they've read the release notes. If you release a patch or a minor, your customers should expect zero breaking changes and shouldn't be afraid to update their applications. This is critical for maintaining trust and keeping people as up-to-date as possible.
