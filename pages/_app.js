        ...
        <section>
          ...
          <footer className={styles.footer} id="contact">
            ...
            <ul className={styles.footer__list}>
              <li className={styles.footer__list__item}><Link href="https://www.linkedin.com/in/iamtyce/" className={styles.footer__list__link}>LinkedIn</Link></li>
              <li className={styles.footer__list__item}><Link href="https://open.spotify.com/user/iamtyce?si=4c4de1ad9f064d65" className={styles.footer__list__link}>Spotify</Link></li>
